...
includeScript ('../assets/booking/js/jquery-ui-1.10.3.custom.min.js');
includeScript ('../assets/booking/js/jquery.fancyform.js');
includeScript ('../assets/booking/js/jquery.placeholder.js');
includeScript ('../assets/booking/js/regula.js');
